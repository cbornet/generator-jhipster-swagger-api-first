...
module.exports = JhipsterGenerator.extend({
    initializing: {
        ...
        displayLogo() {
            this.log(chalk.white('Running ' + chalk.bold('JHipster swagger-api-first') + ' Generator! ' + chalk.yellow('v' + packagejs.version + '\n')));
        },
        validate() {
    ...
    writing: {
        ...
        if (this.yourOptionKey){
            this.log('\n' + chalk.bold.green('swagger-api-first enabled'));
        }
    }
});
